...
public enum Material {
    ...
    ODB_KIER(1, 1, 0.03, 0, 1, 2, 200),
    ODB_KIER_ROZPR(1, 1, 0.03, 0.25, 0.75, 2, 100),
    ODB_ROZPR_KIER(1, 1, 0.03, 0.75, 0.25, 2, 50),
    ODB_ROZPR(1, 1, 0.03, 1, 0, 2, 1),
    ODB_KIER_ROPR_MAKS(1, 1, 0.03, 1, 1, 2, 200);
